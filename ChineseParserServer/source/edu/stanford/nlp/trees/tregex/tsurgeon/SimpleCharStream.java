...
/*     */   
/*  22 */   protected static boolean prevCharIsCR = false;
/*  23 */   protected static boolean prevCharIsLF = false;
/*     */   
...
/*  42 */         System.arraycopy(buffer, 0, newbuffer, bufsize - tokenBegin, bufpos);
/*     */         
/*  44 */         buffer = newbuffer;
/*     */         
...
/*     */     }
/* 278 */     prevCharIsLF = prevCharIsCR = 0;
...
/*     */   {
/* 296 */     this(new InputStreamReader(dstream), startline, startcolumn, 4096);
/*     */   }
/*     */   
/*     */ 
...
/*     */   {
/* 313 */     ReInit(new InputStreamReader(dstream), startline, startcolumn, 4096);
/*     */   }
/*     */   
...
/*     */     }
/* 330 */     return new String(buffer, tokenBegin, bufsize - tokenBegin) + new String(buffer, 0, bufpos + 1);
/*     */   }
/*     */   
/*     */ 
...
/*     */     }
/*     */     else {
/* 342 */       System.arraycopy(buffer, bufsize - (len - bufpos - 1), ret, 0, len - bufpos - 1);
/*     */       
...
/*     */     }
/*     */     
/* 374 */     int i = 0;int j = 0;int k = 0;
/* 375 */     int nextColDiff = 0;int columnDiff = 0;
/*     */     
/*     */ 
/* 378 */     while ((i < len) && (bufline[(j = start % bufsize)] == bufline[(k = ++start % bufsize)]))
/*     */     {
...
/* Location:              D:\Project\TTS\PearSynthesizer(HMM)\ChineseParserServer\lib\Stanford.jar!\edu\stanford\nlp\trees\tregex\tsurgeon\SimpleCharStream.class
